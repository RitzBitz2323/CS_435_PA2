...
public class SimilarDocuments {
    ...
    public ArrayList<String> similaritySearch(String docName) {
        ArrayList<String> resultList = lsh.retrieveSim(this.nameOfFolder + "/" + docName);
    ...
    public static void main(String[] args) {
        ...
        similarDocumentsTest.similaritySearch("space-9.txt.copy1");
        similarDocumentsTest.similaritySearch("space-86.txt");
        similarDocumentsTest.similaritySearch("space-87.txt");
        similarDocumentsTest.similaritySearch("space-88.txt");
        similarDocumentsTest.similaritySearch("space-89.txt");

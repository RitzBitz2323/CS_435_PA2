...
public class MinHashAccuracy {
    ...
    public static void main(String[] args) {
        ...
        accuraciesFor400Permutations[0] = minHashAccuracy.accuracy("data/test", 400, 0.04);
        accuraciesFor400Permutations[1] = minHashAccuracy.accuracy("data/test", 400, 0.07);
        accuraciesFor400Permutations[2] = minHashAccuracy.accuracy("data/test", 400, 0.09);

        int[] accuraciesFor600Permutations = new int[3];
        accuraciesFor600Permutations[0] = minHashAccuracy.accuracy("data/test", 600, 0.04);
        accuraciesFor600Permutations[1] = minHashAccuracy.accuracy("data/test", 600, 0.07);
        accuraciesFor600Permutations[2] = minHashAccuracy.accuracy("data/test", 600, 0.09);

        int[] accuraciesFor800Permutations = new int[3];
        accuraciesFor800Permutations[0] = minHashAccuracy.accuracy("data/test", 800, 0.04);
        accuraciesFor800Permutations[1] = minHashAccuracy.accuracy("data/test", 800, 0.07);
        accuraciesFor800Permutations[2] = minHashAccuracy.accuracy("data/test", 800, 0.09);

        // Print table rows
        System.out.format("%s%10s%10s%10s%n", " ", "epsilon = 0.04", "epsilon = 0.07", "epsilon = 0.09");
